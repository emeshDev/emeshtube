...
function handleCors(request: Request): Response {
  return new Response(null, {
    headers: {
      ...
      "Access-Control-Allow-Headers": "Content-Type, Authorization, x-video-id, x-middleware-rewrite",
...
function addCorsHeaders(response: Response): Response {
  ...
  newHeaders.set("Access-Control-Allow-Headers", "Content-Type, Authorization, x-video-id, x-middleware-rewrite");
